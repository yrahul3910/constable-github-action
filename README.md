...
Constable is a GitHub action to grade the repositories contributability. Simply add a action to any GitHub Actions workflow you like and start seeing how contributable your repository is. A sample workflow is provided below:
